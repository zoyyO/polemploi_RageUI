...
--- Généré par zoyy0
--- Créé par zoyy0
--- DateHeure: 18/04/2021 12:40
---

print("")
print("^1Auteur : zoyy0 (zoyy0#3385)^0")
print("^4Contributeur : Chris Bioshield.^0")
print("")
print("^2[NOUS REJOINDRE] : https://discord.gg/")
print("^2[Twitter] : N/A^0")
print("")
print("^6RageUI, Format du script réalisé.^0")
print("")
print("^6Il vous est interdit de voler ce script à des fin personnel ou pour remplir votre compte bancaire. Sous peine d'être poursuivie en justice.^0")
print("")
...
RageUI.Settings = {
    ...
    Controls = {
        ...
        Enabled = {
            Controller = {
                { 0, 2 }, -- Regarder de haut en bas
                { 0, 1 }, -- Regarder de gauche à droite
                { 0, 25 }, -- objectif
                { 0, 24 }, -- Attaque
            },
            Keyboard = {
                ...
                { 0, 202 }, -- Retour
                { 0, 217 }, -- Selectionner
                { 0, 242 }, -- Défiler vers le bas
                { 0, 241 }, -- Défiler vers le haut
                { 0, 239 }, -- Curseur X
                { 0, 240 }, -- Curseur Y
                { 0, 31 }, 	-- Déplacer de Haut en bas
                { 0, 30 }, 	-- Déplacer à gauche et à droite
                { 0, 21 }, 	-- Courir
                { 0, 22 }, 	-- Sauter
                { 0, 23 }, 	-- Entrée
                { 0, 75 }, 	-- Sortir Véhicule
                { 0, 71 }, 	-- Accélération Véhicule
                { 0, 72 }, 	-- Frein Véhicule
                { 0, 59 }, 	-- Déplacer le véhicule à gauche et à droite
                { 0, 89 }, 	-- Déporter à gauche
                { 0, 9 }, 	-- Voler à gauche et à droite
                { 0, 8 }, 	-- Voler de haut en bas
                { 0, 90 }, 	-- Déporter à droite
                { 0, 76 }, 	-- Frein à main Véhicule
            },
        },
    },
    Audio = {
...
function RageUI.Banner(Enabled, Glare)
    if type(Enabled) == "boolean" then
        ...
        error("boolean n'est pas activé")
    end
end
