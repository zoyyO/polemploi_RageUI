        ...
        if CurrentMenu() then
            ...
            if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
                ...
                if type(Style) == "table" then
                    ...
                    error("Le style UICheckBox n'est pas une `table`")
                end
                ...
                if (type(Style.ProgressBackgroundColor) == "table") then
                    ...
                    error("Le style ProgressBackgroundColor n'est pas une table ou n'est pas défini")
                end
                ...
                if (type(Style.ProgressColor) == "table") then
                    ...
                    error("Le style ProgressColor n'est pas une table ou n'est pas défini")
                end
