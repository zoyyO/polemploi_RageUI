...
---- événement du serveur pour afficher la notification
...
function RageUI.Popup(array)
    ...
    if (array.message == nil) then
        error("Arguments manquants, message")
    else
    ...
    if (array.sound ~= nil) then
        if (array.sound.audio_name ~= nil) then
            if (array.sound.audio_ref ~= nil) then
                ...
                error("Arguments manquants, audio_ref")
            end
        else
            error("Arguments manquants, audio_name")
        end
    end
end
